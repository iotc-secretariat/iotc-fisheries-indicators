...
```{r AnnualNominalEffort, fig.cap = "Annual changes in estimated nominal effort (standardised to the mean) for some fisheries, 1952-2021. MDV = Maldives; LKA = Sri Lanka; ASIAN-LL = China, Korea, and Taiwan,China; EU-ASS = Spain, France and Seychelles"}
