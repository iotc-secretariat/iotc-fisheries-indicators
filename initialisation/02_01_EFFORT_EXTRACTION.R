...
CE_RAW_LL_HOOKS_TROP = CE_raw(species_codes = c("BET", "YFT", "SKJ"), fishery_group_codes = "LL", effort_unit_codes = "HOOKS", fleet_codes = LL_MAIN_FLEETS)
...
EF_PS_FDAYS_YEAR_MAIN = EF_PS_FDAYS_YEAR_FLEET[, .(FLEET_CODE = "EU-SYC", FLEET = "Main fleets", EFFORT = sum(EFFORT)), keyby = .(YEAR, UNIT, FISHERY_GROUP_CODE, FISHERY_GROUP)]
